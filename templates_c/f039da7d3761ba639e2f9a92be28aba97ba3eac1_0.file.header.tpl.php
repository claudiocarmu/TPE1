<?php
/* Smarty version 3.1.39, created on 2021-10-11 01:51:20
  from 'C:\xampp\htdocs\TPE1\templates\header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61637c78546fa4_37195282',
...
function content_61637c78546fa4_37195282 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <?php if ((isset($_SESSION['USER_ID']))) {?>
                            <li class="nav-item ms-auto"><a class="nav-link active" href="logout"><?php echo $_SESSION['USER_EMAIL'];?>
 Logout</a></li>
                        <?php } else { ?>
                            <li class="nav-item ms-auto"><a class="nav-link active" href="login">Ingresar</a></li>
                        <?php }?>
                        </div>
                    </ul>
                </div>
